...
const LawOfReflectionRenderer: React.FC<LawOfReflectionRendererProps> = ({
  ...
  const [numReflections, setNumReflections] = useState(2);
  ...
  const handleTestAnswer = (questionIndex: number, optionId: string) => {
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 700,
            fontSize: '14px',
            background: canProceed ? `linear-gradient(135deg, ${colors.accent}, #3b82f6)` : 'rgba(30, 41, 59, 0.9)',
    ...
    return (
      <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} style={{ display: 'block', margin: '0 auto', background: colors.bgCard, borderRadius: '12px' }}>
        ...
        <text x={width/2} y={height - 28} textAnchor="middle" fill={colors.textSecondary} fontSize="11">
          Two 90deg reflections rotate beam 180deg - perfect for road signs and lunar ranging
        </text>
      </svg>
    );
  };
      ...
      <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
        <button
          ...
          style={{
            ...
            background: showNormal ? 'rgba(148, 163, 184, 0.2)' : 'transparent',
            color: colors.textPrimary,
            cursor: 'pointer',
            fontSize: typo.small,
          }}
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '20px', borderRadius: '12px', marginBottom: '16px' }}>
            ...
            <ul style={{ lineHeight: 1.8, paddingLeft: '20px', color: colors.textSecondary, fontSize: typo.body }}>
              <li><strong>theta_i</strong> - Angle of incidence (incoming ray to normal)</li>
              <li><strong>theta_r</strong> - Angle of reflection (outgoing ray to normal)</li>
              <li>Both angles measured from the <strong>normal</strong> (not the mirror surface)</li>
            </ul>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '12px' }}>
            <div style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
              ...
              <p style={{ color: colors.textMuted, fontSize: typo.label, marginTop: '4px' }}>Not from the mirror surface!</p>
            </div>
            <div style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
              <div style={{ fontSize: '24px', marginBottom: '8px' }}>↔️</div>
              <div style={{ color: colors.textPrimary, fontWeight: 600, fontSize: typo.small }}>Same Plane</div>
              <p style={{ color: colors.textMuted, fontSize: typo.label, marginTop: '4px' }}>Incident, reflected, normal coplanar</p>
            </div>
            <div style={{ background: 'rgba(30, 41, 59, 0.8)', padding: '16px', borderRadius: '8px', textAlign: 'center' }}>
              <div style={{ fontSize: '24px', marginBottom: '8px' }}>👻</div>
              <div style={{ color: colors.textPrimary, fontWeight: 600, fontSize: typo.small }}>Virtual Images</div>
              <p style={{ color: colors.textMuted, fontSize: typo.label, marginTop: '4px' }}>Appear behind the mirror</p>
            </div>
          </div>
        </div>
      </div>,
  ...
  if (phase === 'twist_predict') {
    return wrapPhaseContent(
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: typo.body, marginBottom: '12px', lineHeight: 1.6 }}>
              You place <strong>two mirrors at a 90 degree angle</strong> to each other (like a corner). If you shine light at one mirror...
            </p>
      ...
      renderBottomBar(!!twistPrediction, 'See It In Action')
    );
  }
      ...
      <div style={{ padding: typo.pagePadding, paddingBottom: '16px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <div style={{
            ...
            <p style={{ fontSize: typo.body, lineHeight: 1.6 }}>
              A corner reflector sends light back <strong>parallel to the original direction</strong>! Two 90-degree reflections rotate the beam by 180 degrees. This is called <strong>retroreflection</strong>.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: colors.textSecondary, fontSize: typo.body, lineHeight: 1.6 }}>
              This is why <strong>bike reflectors</strong> and <strong>road signs</strong> are visible from any angle - they contain tiny corner cube reflectors that send headlight beams straight back to the driver!
            </p>
          </div>
        </div>
      </div>,
  ...
  if (phase === 'test') {
    if (testSubmitted) {
      return wrapPhaseContent(
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            <div style={{
              ...
              <p style={{ color: colors.textMuted, fontSize: typo.body }}>
                {testScore >= 7 ? 'You understand the Law of Reflection!' : 'Review the concepts and try again.'}
              </p>
            </div>
        ...
        renderBottomBar(true, testScore >= 7 ? 'Claim Mastery' : 'Try Again', testScore >= 7 ? goNext : () => {
    ...
    return wrapPhaseContent(
      <div style={{ padding: typo.pagePadding, paddingBottom: '16px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <h3 style={{ fontSize: typo.body, marginBottom: '16px', lineHeight: 1.5 }}>
            {currentQ.question}
          </h3>
            ...
            {currentQ.options.map((opt) => (
              <button
                ...
                style={{
                  ...
                  background: testAnswers[currentTestQuestion] === opt.id ? `${colors.accent}22` : 'rgba(30, 41, 59, 0.5)',
                  color: colors.textPrimary,
                  cursor: 'pointer',
                  textAlign: 'left',
                  fontSize: typo.small,
              ...
              >
                <span style={{
                  ...
                  height: '24px',
                  borderRadius: '50%',
                  background: testAnswers[currentTestQuestion] === opt.id ? colors.accent : 'rgba(30, 41, 59, 0.9)',
                  color: testAnswers[currentTestQuestion] === opt.id ? 'white' : colors.textSecondary,
                  textAlign: 'center',
                  lineHeight: '24px',
                  marginRight: '10px',
                  fontSize: '11px',
      ...
      <div style={{ padding: typo.pagePadding, paddingBottom: '16px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: colors.textMuted, marginBottom: '32px', fontSize: typo.body }}>
            You now understand the elegant law that governs all mirrors and reflective surfaces
          </p>
