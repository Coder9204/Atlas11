...
const TEST_QUESTIONS = [
  {
    ...
    explanation: 'Magnetic field lines point from the north pole to the south pole outside the magnet, forming continuous loops that re-enter through the south pole.'
  },
  {
    ...
    explanation: 'Closely spaced field lines indicate a stronger magnetic field, as the density of field lines is proportional to field strength.'
  },
  {
    ...
    explanation: 'At any point in space, the magnetic field has a single unique direction, so field lines cannot cross because that would imply two directions at one point.'
  },
  {
    ...
    explanation: 'A compass needle is a small permanent magnet that freely rotates to align with the local magnetic field lines, with its north-seeking pole pointing along the field direction.'
  },
  {
    ...
    explanation: 'Magnetic field strength decreases as the inverse cube of distance from a magnetic dipole, which is much faster than the inverse-square law of gravity or electrostatics.'
  },
  {
    ...
    explanation: 'Magnetic declination is the angle between the direction a compass points (magnetic north) and the direction to the geographic North Pole (true north).'
  },
  {
    ...
    explanation: 'Earth\'s magnetic field is generated by convection currents of molten iron in the outer core, which act as a natural dynamo through the motion of electrically conductive fluid.'
  },
  {
    ...
    explanation: 'Iron filings become temporarily magnetized and align along the local field direction, collectively revealing the pattern of magnetic field lines around the magnet.'
  },
  {
    ...
    explanation: 'The magnetic field is strongest at the poles where field lines converge and are most densely packed, and weakest at the center of the magnet where field lines spread out.'
  },
  {
    ...
    explanation: 'A compass north pole is attracted to Earth\'s magnetic south pole, which is located near the geographic North Pole, because opposite magnetic poles attract.'
  }
];
