  ...
  const renderHook = () => (
    <div className="flex flex-col items-center justify-center min-h-[600px] px-6 py-12 text-center">
      ...
      <p className="text-lg text-slate-400 max-w-md mb-10">
        A 2,000-year-old discovery that works exactly like your eye
      </p>
        ...
        <div className="relative">
          ...
          <div className="mt-8 space-y-4">
            <p className="text-xl text-white/90 font-medium leading-relaxed">
              A tiny hole in a dark room projects perfect images
            </p>
            <p className="text-lg text-slate-400 leading-relaxed">
              No lens, no film, no electronics - just a hole and physics!
            </p>
            <div className="pt-2">
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/50">
        <div className="flex items-center justify-between px-6 py-3 max-w-4xl mx-auto">
          <span className="text-sm font-semibold text-white/80 tracking-wide">Camera Obscura</span>
