  ...
  const testQuestions = [
    {
      ...
      explanation: 'The inverse-square law states that intensity decreases as 1/r^2, so doubling distance reduces intensity to one-quarter.',
    },
    {
      ...
      explanation: 'The cosine of 60 degrees is 0.5, so the effective projected area capturing photons is half the maximum, yielding about 50% of peak output.',
    },
    {
      ...
      explanation: 'Solar cell current is generated by absorbed photons creating electron-hole pairs, so more photons (higher intensity) produce proportionally more current.',
    },
    {
      ...
      explanation: 'Solar cell voltage is determined by the semiconductor bandgap and junction properties, with only a weak logarithmic dependence on light intensity.',
    },
    {
      ...
      explanation: 'Power output scales nearly linearly with intensity because current increases proportionally while voltage stays approximately constant.',
    },
    {
      ...
      explanation: 'Concentrating light increases current and power significantly, but the excess energy becomes heat that can damage the cell without proper thermal management.',
    },
    {
      ...
      explanation: 'The cosine law arises because the effective area intercepting light decreases as the cosine of the angle between the incoming light and the surface normal.',
    },
    {
      ...
      explanation: 'A perpendicular panel presents its full area to the incoming light, intercepting the maximum number of photons per unit cell area.',
    },
    {
      ...
      explanation: 'The inverse-square law applies because light radiates outward in all directions, spreading over a sphere whose area grows as 4*pi*r^2.',
    },
    {
      ...
      explanation: 'Solar cell efficiency is the ratio of electrical power output to the total light power incident on the cell surface.',
    },
  ];
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
        <svg
         ...
         role="img" aria-label="Solar Cell visualization">
          <defs>
