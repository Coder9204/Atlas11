  ...
  const renderHook = () => (
    <div className="flex flex-col items-center justify-center min-h-[600px] px-6 py-12 text-center">
      ...
      <p className="text-lg text-slate-400 max-w-md mb-10">
        Discover how your brain pinpoints sound locations with incredible precision
      </p>
        ...
        <div className="relative">
          ...
          <div className="space-y-4">
            <p className="text-xl text-white/90 font-medium leading-relaxed">
              Close your eyes and someone snaps their fingers
            </p>
            <p className="text-lg text-slate-400 leading-relaxed">
              Instantly, you know exactly where they are! Your brain performs incredible calculations using just two ears, separated by 17 centimeters.
            </p>
            <div className="pt-2">
              <p className="text-base text-blue-400 font-semibold">
                What clues does your brain use?
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/50">
        <div className="flex items-center justify-between px-6 py-3 max-w-4xl mx-auto">
          <span className="text-sm font-semibold text-white/80 tracking-wide">Sound Localization</span>
