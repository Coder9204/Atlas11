...
const InverterSineWaveRenderer: React.FC<InverterSineWaveRendererProps> = ({
  ...
  // Real-world applications data for transfer phase
  const realWorldApps = [
    {
      icon: 'Sun',
      title: 'Solar Inverters',
      short: 'Converting solar DC to grid AC',
      tagline: 'The heart of every solar power system',
      description: 'Solar inverters convert the DC electricity generated by photovoltaic panels into AC electricity that can power homes, businesses, and feed into the utility grid. Modern solar inverters use advanced PWM techniques with switching frequencies of 20-50kHz to produce pure sine wave output with THD below 3%, meeting strict grid interconnection standards.',
      connection: 'The PWM sine wave synthesis and LC filtering techniques you learned are exactly how solar inverters produce grid-quality AC power from solar panel DC output.',
      howItWorks: 'Solar panels produce variable DC voltage (typically 300-600V). The inverter uses an H-bridge with high-frequency PWM switching, where the duty cycle varies sinusoidally to create an average voltage that follows a sine wave. An LC output filter removes switching harmonics, producing clean 60Hz AC synchronized to the grid.',
      stats: [
      ...
      examples: [
        ...
        'Commercial solar installations (50-500kW)',
        'Utility-scale solar farms (1-500MW)',
        'Solar microinverters on each panel'
      ],
      companies: ['Enphase', 'SolarEdge', 'SMA', 'Fronius', 'Huawei'],
      futureImpact: 'Solar inverters are driving the global transition to renewable energy, with global solar capacity expected to triple by 2030. Next-generation inverters will incorporate AI-based maximum power point tracking, predictive maintenance, and smart grid support for frequency regulation and reactive power compensation.',
      color: '#f59e0b'
    },
    {
      icon: 'Battery',
      ...
      description: 'Uninterruptible Power Supplies (UPS) use double-conversion topology where incoming AC is rectified to DC, stored in batteries, and continuously inverted back to AC. This provides complete isolation from grid disturbances and instant backup power during outages, protecting sensitive equipment like servers, medical devices, and industrial controls.',
      connection: 'UPS inverters apply the same H-bridge PWM switching and filtering principles, but must maintain precise frequency and voltage regulation while seamlessly transitioning between grid and battery power.',
      howItWorks: 'Online UPS systems continuously convert AC to DC (charging batteries) and DC back to AC using PWM inverters. The output is always generated by the inverter, providing complete power conditioning. When grid power fails, the batteries seamlessly continue powering the inverter with zero transfer time.',
      stats: [
        { value: '0ms', label: 'Transfer Time' },
        { value: '94-96%', label: 'Double Conversion Efficiency' },
        { value: '<2%', label: 'Output THD' }
      ],
      examples: [
        'Data center server protection',
        'Hospital life-support equipment',
        'Industrial process control systems',
        'Telecommunications infrastructure'
      ],
      companies: ['APC (Schneider)', 'Eaton', 'Vertiv', 'CyberPower'],
      futureImpact: 'Modern UPS systems are evolving into grid-interactive energy storage systems, capable of providing demand response, peak shaving, and renewable energy integration. Lithium-ion batteries are replacing lead-acid for higher energy density and longer life.',
      color: '#3b82f6'
    },
    {
      icon: 'Car',
      title: 'Electric Vehicle Drives',
      short: 'Powering EV motors with precision',
      tagline: 'High-performance traction inverters',
      description: 'Electric vehicle traction inverters convert DC from the battery pack (typically 400-800V) into three-phase AC to drive the electric motor. Using advanced PWM with switching frequencies up to 20kHz and silicon carbide (SiC) MOSFETs, these inverters achieve 98%+ efficiency while providing precise torque and speed control.',
      connection: 'EV inverters use the same PWM principles but create three-phase AC with variable frequency and voltage. The V/f ratio control and field-oriented control algorithms build on the fundamental switching concepts you learned.',
      howItWorks: 'The inverter uses six switches (three half-bridges) to create three-phase AC. PWM duty cycles are calculated using space vector modulation to produce rotating magnetic fields in the motor. By varying the PWM frequency and amplitude, the inverter controls motor speed from 0 to 20,000+ RPM with precise torque response.',
      stats: [
        { value: '98%+', label: 'Inverter Efficiency' },
        { value: '200kW+', label: 'Peak Power Output' },
        { value: '20kHz', label: 'Switching Frequency' }
      ],
      examples: [
        'Tesla Model 3/Y rear motor inverter',
      ...
      futureImpact: 'Next-generation 800V vehicle architectures with silicon carbide inverters will enable faster charging and longer range. Integrated motor-inverter-gearbox units reduce weight and cost. Vehicle-to-grid (V2G) capability will turn EVs into mobile power plants.',
      color: '#22c55e'
    },
    {
      icon: 'Zap',
      title: 'Grid-Tie Systems',
      short: 'Synchronizing distributed energy to the grid',
      tagline: 'Seamless utility interconnection',
      description: 'Grid-tie inverters synchronize distributed energy resources (solar, wind, batteries) with the utility grid by matching frequency, voltage, and phase angle precisely. They must meet strict power quality standards (IEEE 1547) and include anti-islanding protection to disconnect during grid outages for worker safety.',
      connection: 'Grid-tie systems demonstrate why pure sine wave output with low THD is critical. The inverter must produce current that is perfectly in phase with grid voltage to transfer real power, using phase-locked loops and current control algorithms.',
      howItWorks: 'A phase-locked loop (PLL) continuously tracks grid voltage to synchronize the inverter output. Current control loops regulate the injected current to be sinusoidal and in phase with voltage. Anti-islanding detection monitors grid impedance and frequency to detect outages within 2 seconds.',
      stats: [
        { value: '<5%', label: 'THD Limit (IEEE 1547)' },
        { value: '0.99', label: 'Power Factor Range' },
        { value: '<2s', label: 'Anti-Islanding Detection' }
      ],
      examples: [
        'Net-metered residential solar systems',
        'Community solar farms feeding distribution grid',
        'Wind turbine grid connection inverters',
        'Battery energy storage grid integration'
      ],
      companies: ['SMA', 'ABB', 'GE Renewable Energy', 'Siemens Gamesa'],
      futureImpact: 'Smart inverters are becoming grid-forming rather than just grid-following, capable of creating stable voltage and frequency references. This enables 100% renewable grids without traditional synchronous generators. Virtual power plants will aggregate thousands of distributed inverters for grid stability.',
      color: '#a855f7'
    }
  ];
