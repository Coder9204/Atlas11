...
// Animation loop
  ...
  if (phase === 'transfer') {
    return (
      <TransferPhaseView
        conceptName="E L O N_ Gigawatt Blueprint"
  ...
  {testQuestions.map((q, idx) => {
    const userAnswer = testAnswers[idx]; const correctOption = q.options.find(o => o.correct); const userOption = q.options.find(o => o.id === userAnswer); const isCorrect = userAnswer === correctOption?.id;
    return (
    ...
    return (
      <div style={{
        ...
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, padding: '16px 20px', background: 'linear-gradient(to top, rgba(15, 23, 42, 0.98), rgba(15, 23, 42, 0.9))', borderTop: '1px solid rgba(148, 163, 184, 0.2)', zIndex: 1000 }}>
          <button onClick={() => { if (onGameEvent) { onGameEvent({ eventType: 'mastery_achieved', gameType: 'gigawatt-blueprint', gameTitle: 'Gigawatt Blueprint', details: { score: testScore, total: testQuestions.length }, timestamp: Date.now() }); } window.location.href = '/games'; }}
