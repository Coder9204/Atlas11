...
export default function DispersionRenderer() {
  ...
  const renderHook = () => (
    ...
    >
      ...
      >
        Tilt a CD in sunlight and watch
        <span style={{ color: defined.colors.accent, fontWeight: defined.typography.weights.semibold }}>
          {' '}
          rainbow colors dance
        </span>{' '}
        across its surface. White light contains a hidden spectrum - how does it separate into
        colors?
      </p>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: defined.radius.lg,
            background:
              'linear-gradient(90deg, #8B5CF6, #6366F1, #3B82F6, #22C55E, #EAB308, #F97316, #EF4444)',
            marginBottom: defined.spacing.md,
          }}
        />
        <div
