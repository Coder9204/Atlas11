...
const gameTiers = {
  ...
  functional: [
    ...
    { id: 'pv_iv_curve', name: 'PV I-V Curve', icon: '📈', color: 'from-amber-500 to-orange-400' },
    { id: 'dc_dc_converter', name: 'DC-DC Converter', icon: '🔄', color: 'from-amber-500 to-orange-400' },
    { id: 'inverter_sine_wave', name: 'Inverter Sine Wave', icon: '〰️', color: 'from-amber-500 to-orange-400' },
    { id: 'battery_internal_resistance', name: 'Battery Internal Resistance', icon: '🔋', color: 'from-amber-500 to-orange-400' },
    { id: 'solar_temp_coefficient', name: 'Solar Temp Coefficient', icon: '🌡️', color: 'from-amber-500 to-orange-400' },
    { id: 'bypass_diodes', name: 'Bypass Diodes', icon: '⚡', color: 'from-amber-500 to-orange-400' },
    { id: 'grid_frequency', name: 'Grid Frequency', icon: '📊', color: 'from-amber-500 to-orange-400' },
    { id: 'power_factor', name: 'Power Factor', icon: '⚡', color: 'from-amber-500 to-orange-400' },
    { id: 'string_sizing', name: 'String Sizing', icon: '🔗', color: 'from-amber-500 to-orange-400' },
    { id: 'ground_fault', name: 'Ground Fault', icon: '⚠️', color: 'from-amber-500 to-orange-400' },
    { id: 'heat_sink_thermal', name: 'Heat Sink Thermal', icon: '🌡️', color: 'from-cyan-500 to-blue-400' },
    { id: 'server_airflow', name: 'Server Airflow', icon: '💨', color: 'from-cyan-500 to-blue-400' },
    { id: 'pue_calculator', name: 'PUE Calculator', icon: '📊', color: 'from-cyan-500 to-blue-400' },
    { id: 'liquid_cooling', name: 'Liquid Cooling', icon: '💧', color: 'from-cyan-500 to-blue-400' },
    { id: 'ups_battery_sizing', name: 'UPS Battery Sizing', icon: '🔋', color: 'from-cyan-500 to-blue-400' },
    { id: 'generator_startup', name: 'Generator Startup', icon: '⚙️', color: 'from-cyan-500 to-blue-400' },
    { id: 'cable_sizing', name: 'Cable Sizing', icon: '🔌', color: 'from-cyan-500 to-blue-400' },
    { id: 'humidity_esd', name: 'Humidity & ESD', icon: '⚡', color: 'from-cyan-500 to-blue-400' },
    { id: 'fiber_signal_loss', name: 'Fiber Signal Loss', icon: '🔴', color: 'from-cyan-500 to-blue-400' },
    { id: 'network_latency', name: 'Network Latency', icon: '🌐', color: 'from-cyan-500 to-blue-400' },
    { id: 'hdd_physics', name: 'HDD Physics', icon: '💾', color: 'from-cyan-500 to-blue-400' },
    { id: 'emi_shielding', name: 'EMI Shielding', icon: '🛡️', color: 'from-cyan-500 to-blue-400' },
    { id: 'mosfet_switching', name: 'MOSFET Switching', icon: '⚡', color: 'from-purple-500 to-pink-400' },
    { id: 'rc_delay_interconnect', name: 'RC Delay', icon: '📶', color: 'from-purple-500 to-pink-400' },
    { id: 'clock_distribution', name: 'Clock Distribution', icon: '⏰', color: 'from-purple-500 to-pink-400' },
    { id: 'power_delivery_network', name: 'Power Delivery', icon: '⚡', color: 'from-purple-500 to-pink-400' },
    { id: 'electromigration', name: 'Electromigration', icon: '🔬', color: 'from-purple-500 to-pink-400' },
    { id: 'thermal_throttling', name: 'Thermal Throttling', icon: '🌡️', color: 'from-purple-500 to-pink-400' },
    { id: 'esd_protection', name: 'ESD Protection', icon: '⚡', color: 'from-purple-500 to-pink-400' },
    { id: 'noise_margin', name: 'Noise Margin', icon: '📊', color: 'from-purple-500 to-pink-400' },
    { id: 'transmission_line', name: 'Transmission Line', icon: '📡', color: 'from-purple-500 to-pink-400' },
    { id: 'leakage_current', name: 'Leakage Current', icon: '💧', color: 'from-purple-500 to-pink-400' },
    { id: 'photolithography', name: 'Photolithography', icon: '🔬', color: 'from-purple-500 to-pink-400' },
    { id: 'sram_cell', name: 'SRAM Cell', icon: '💾', color: 'from-purple-500 to-pink-400' },
    { id: 'dram_refresh', name: 'DRAM Refresh', icon: '🔄', color: 'from-purple-500 to-pink-400' },
    { id: 'gpu_memory_bandwidth', name: 'GPU Memory Bandwidth', icon: '📊', color: 'from-green-500 to-emerald-400' },
    { id: 'tensor_core', name: 'Tensor Core', icon: '🧮', color: 'from-green-500 to-emerald-400' },
    { id: 'gpu_power_states', name: 'GPU Power States', icon: '⚡', color: 'from-green-500 to-emerald-400' },
    { id: 'pcie_bandwidth', name: 'PCIe Bandwidth', icon: '🔗', color: 'from-green-500 to-emerald-400' },
    { id: 'quantization_precision', name: 'Quantization', icon: '📉', color: 'from-green-500 to-emerald-400' },
    { id: 'memory_hierarchy', name: 'Memory Hierarchy', icon: '📚', color: 'from-green-500 to-emerald-400' },
    { id: 'interconnect_topology', name: 'Interconnect Topology', icon: '🔗', color: 'from-green-500 to-emerald-400' },
    { id: 'tpu_vs_gpu', name: 'TPU vs GPU', icon: '🤖', color: 'from-green-500 to-emerald-400' },
    { id: 'ai_inference_latency', name: 'AI Inference Latency', icon: '⏱️', color: 'from-green-500 to-emerald-400' },
    { id: 'chiplet_architecture', name: 'Chiplet Architecture', icon: '🧩', color: 'from-green-500 to-emerald-400' },
    { id: 'orbital_mechanics_basics', name: 'Orbital Mechanics', icon: '🛰️', color: 'from-indigo-500 to-violet-400' },
    { id: 'link_budget', name: 'Link Budget', icon: '📡', color: 'from-indigo-500 to-violet-400' },
    { id: 'satellite_thermal', name: 'Satellite Thermal', icon: '🌡️', color: 'from-indigo-500 to-violet-400' },
    { id: 'radiation_effects', name: 'Radiation Effects', icon: '☢️', color: 'from-indigo-500 to-violet-400' },
    { id: 'satellite_doppler', name: 'Satellite Doppler', icon: '📶', color: 'from-indigo-500 to-violet-400' },
    { id: 'led_as_solar_cell', name: 'LED as Solar Cell', icon: '💡', color: 'from-amber-500 to-orange-400' },
    { id: 'spectral_mismatch', name: 'Spectral Mismatch', icon: '🌈', color: 'from-amber-500 to-orange-400' },
    { id: 'fill_factor', name: 'Fill Factor', icon: '📊', color: 'from-amber-500 to-orange-400' },
    { id: 'shunt_series_defects', name: 'Shunt vs Series Defects', icon: '⚡', color: 'from-amber-500 to-orange-400' },
    { id: 'anti_reflective_coating', name: 'Anti-Reflective Coating', icon: '🔍', color: 'from-amber-500 to-orange-400' },
    { id: 'silicon_texturing', name: 'Silicon Texturing', icon: '🔺', color: 'from-amber-500 to-orange-400' },
    { id: 'passivation_recombination', name: 'Passivation & Recombination', icon: '🛡️', color: 'from-amber-500 to-orange-400' },
    { id: 'doping_diffusion', name: 'Doping Diffusion', icon: '🧪', color: 'from-amber-500 to-orange-400' },
    { id: 'screen_printing_metallization', name: 'Screen Printing Metallization', icon: '🖨️', color: 'from-amber-500 to-orange-400' },
    { id: 'cell_to_module_losses', name: 'Cell-to-Module Losses', icon: '📉', color: 'from-amber-500 to-orange-400' },
    { id: 'encapsulation_uv_aging', name: 'Encapsulation & UV Aging', icon: '☀️', color: 'from-amber-500 to-orange-400' },
    { id: 'hotspots', name: 'Hotspots', icon: '🔥', color: 'from-amber-500 to-orange-400' },
    { id: 'bifacial_albedo', name: 'Bifacial & Albedo', icon: '❄️', color: 'from-amber-500 to-orange-400' },
    { id: 'design_to_fab_translation', name: 'Design-to-Fab Translation', icon: '📐', color: 'from-purple-500 to-pink-400' },
    { id: 'cleanroom_yield', name: 'Cleanroom Yield', icon: '🧹', color: 'from-purple-500 to-pink-400' },
    { id: 'litho_focus_dose', name: 'Litho Focus/Dose', icon: '🎯', color: 'from-purple-500 to-pink-400' },
    { id: 'overlay_error', name: 'Overlay Error', icon: '📏', color: 'from-purple-500 to-pink-400' },
    { id: 'etch_anisotropy', name: 'Etch Anisotropy', icon: '🔻', color: 'from-purple-500 to-pink-400' },
    { id: 'deposition_types', name: 'Deposition Types', icon: '🌫️', color: 'from-purple-500 to-pink-400' },
    { id: 'cmp_planarization', name: 'CMP Planarization', icon: '🪞', color: 'from-purple-500 to-pink-400' },
    { id: 'ion_implantation', name: 'Ion Implantation', icon: '⚛️', color: 'from-purple-500 to-pink-400' },
    { id: 'process_variation', name: 'Process Variation', icon: '📈', color: 'from-purple-500 to-pink-400' },
    { id: 'sram_yield_redundancy', name: 'SRAM Yield & Redundancy', icon: '💾', color: 'from-purple-500 to-pink-400' },
    { id: 'flip_chip_wirebond', name: 'Flip-Chip vs Wirebond', icon: '🔌', color: 'from-purple-500 to-pink-400' },
    { id: 'chiplets_vs_monoliths', name: 'Chiplets vs Monoliths', icon: '🧩', color: 'from-purple-500 to-pink-400' },
    { id: 'solar_vs_ic_purity', name: 'Solar vs IC Purity', icon: '💎', color: 'from-teal-500 to-cyan-400' },
    { id: 'texturing_vs_lithography', name: 'Texturing vs Lithography', icon: '🌊', color: 'from-teal-500 to-cyan-400' },
    { id: 'spec_first_prompting', name: 'Spec-First Prompting', icon: '📋', color: 'from-blue-500 to-indigo-400' },
    { id: 'test_first_prompting', name: 'Test-First Prompting', icon: '✅', color: 'from-blue-500 to-indigo-400' },
    { id: 'tool_aware_prompting', name: 'Tool-Aware Prompting', icon: '🔧', color: 'from-blue-500 to-indigo-400' },
    { id: 'patch_discipline', name: 'Patch Discipline', icon: '🩹', color: 'from-blue-500 to-indigo-400' },
    { id: 'verification_harness', name: 'Verification Harness', icon: '📊', color: 'from-blue-500 to-indigo-400' },
    { id: 'prompt_injection_safety', name: 'Prompt Injection Safety', icon: '🛡️', color: 'from-blue-500 to-indigo-400' },
    { id: 'model_as_reviewer', name: 'Model as Reviewer', icon: '🔍', color: 'from-blue-500 to-indigo-400' },
    { id: 'ask_for_assumptions', name: 'Ask for Assumptions', icon: '❓', color: 'from-blue-500 to-indigo-400' },
    { id: 'solar_yield_prediction', name: 'Solar Yield Prediction', icon: '☀️', color: 'from-teal-500 to-cyan-400' },
    { id: 'llm_to_spice', name: 'LLM to SPICE', icon: '⚡', color: 'from-teal-500 to-cyan-400' },
    { id: 'energy_per_token', name: 'Energy per Token', icon: '🔋', color: 'from-teal-500 to-cyan-400' },
    { id: 'attention_loves_bandwidth', name: 'Attention Loves Bandwidth', icon: '📡', color: 'from-teal-500 to-cyan-400' },
    { id: 'manufacturing_drives_architecture', name: 'Manufacturing Drives Architecture', icon: '🏭', color: 'from-teal-500 to-cyan-400' },
