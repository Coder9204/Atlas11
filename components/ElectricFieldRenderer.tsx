        ...
        <div style={{ padding: '24px', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ padding: '16px' }}>
            ...
            {testQuestions.map((q, idx) => {
              ...
              const userOption = userAnswer >= 0 ? q.options[userAnswer] : null;
  ...
  const renderMastery = () => (
    <div className="flex flex-col items-center justify-center min-h-[500px] p-6 text-center">
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, padding: '16px 20px', background: 'linear-gradient(to top, rgba(15, 23, 42, 0.98), rgba(15, 23, 42, 0.9))', borderTop: '1px solid rgba(148, 163, 184, 0.2)', zIndex: 1000 }}>
        <button onClick={() => { onGameEvent?.({ eventType: 'game_completed', gameType: 'electric_field', gameTitle: 'Electric Fields', details: { phase: 'mastery', score: calculateTestScore(), maxScore: 10 }, timestamp: Date.now() }); window.location.href = '/games'; }}
