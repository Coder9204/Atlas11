  ...
  const testQuestions = [
    {
      ...
      explanation: 'The toroidal rotation is self-reinforcing: fluid circulating around the ring core sustains the low-pressure center that holds the structure together as it propagates.',
    },
    {
      ...
      explanation: 'A vortex ring carries hydrodynamic impulse in its circulation pattern -- the rotating flow transports momentum efficiently without requiring bulk mass displacement.',
    },
    {
      ...
      explanation: 'Viscosity diffuses vorticity outward from the ring core, weakening the circulation. This saps the ring\'s kinetic energy, causing it to decelerate and dissipate faster.',
    },
    {
      ...
      explanation: 'The ring diameter scales with the aperture opening. A larger aperture rolls up a wider shear layer, producing a proportionally larger vortex ring.',
    },
    {
      ...
      explanation: 'Ring velocity is proportional to the circulation strength and inversely related to the ring diameter -- more impulse and a smaller ring produce faster propagation.',
    },
    {
      ...
      explanation: 'The ring transports kinetic energy locked in its rotational flow across large distances, while the surrounding fluid mostly stays in place -- energy moves without mass.',
    },
    {
      ...
      explanation: 'Smoke particles are passive tracers entrained in the vortex core. They make the otherwise invisible air flow pattern visible without altering the ring\'s dynamics.',
    },
    {
      ...
      explanation: 'Slicing through the ring reveals two vortex cores spinning in opposite directions, creating the characteristic recirculating flow that defines the toroidal structure.',
    },
    {
      ...
      explanation: 'Greater impulse imparts more circulation to the ring, increasing its self-induced velocity. The ring travels faster but may also be less stable at very high impulse.',
    },
    {
      ...
      explanation: 'Dolphins eject a quick burst of air from their blowholes, and the impulsive flow rolls up into a toroidal vortex ring that traps the air bubble in its core.',
    },
  ];
