...
const BrewsterAngleRenderer: React.FC<BrewsterAngleRendererProps> = ({
  ...
  const renderBrewsterSimulation = () => {
    ...
    const displayReflection = phase === 'twist_play' ? throughFilter : (reflection.rs + reflection.rp) / 2;
  ...
  const renderHook = () => (
    <div style={{ textAlign: 'center' }}>
      ...
      <p style={{ ...typography.body, color: colors.textSecondary, marginBottom: spacing.lg, maxWidth: 500, margin: '0 auto' }}>
        There's a magic angle where you can completely eliminate glare.
        Photographers and physicists know this secret. At exactly the right angle,
        reflected light becomes 100% polarized - and a simple filter can block it entirely.
      </p>
      <div style={{
