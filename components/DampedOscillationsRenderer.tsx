    ...
    if (testSubmitted) {
      return (
        <div style={{
          ...
          {/* Review answers */}
          <div style={{ padding: '16px', maxWidth: '600px', width: '100%' }}>
          ...
          {currentQuestion < 9 ? (
            ...
            <button
              onClick={() => {
                ...
                onGameEvent?.({ eventType: 'game_completed', gameType: 'damped-oscillations', gameTitle: 'Damped Oscillations', details: { score, total: testQuestions.length }, timestamp: Date.now() });
              }}
