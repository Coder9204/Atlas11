...
const realWorldApps = [
  ...
  },
  {
    ...
    description: 'Every relay, solenoid, and motor produces potentially damaging kickback spikes when switched off. Protection circuits (flyback diodes, snubbers) provide safe paths for the collapsing field energy.',
    stats: [
      ...
      <svg viewBox="0 0 400 220" className="w-full h-52">
        ...
        {switchOn && (
          <>
            ...
            <text x="260" y="55" textAnchor="middle" fill="#a5b4fc" fontSize="10">
              Magnetic Field
            </text>
          </>
        )}
