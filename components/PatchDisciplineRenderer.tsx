...
const PatchDisciplineRenderer: React.FC<PatchDisciplineRendererProps> = ({
  ...
  const [showRollbackDemo, setShowRollbackDemo] = useState(false);
      ...
      <div style={{ height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: colors.bgPrimary }}>
        <div style={{ flex: 1, overflowY: 'auto', paddingBottom: '100px' }}>
          <div style={{ padding: '24px', textAlign: 'center' }}>
            ...
            <p style={{ color: colors.textSecondary, marginBottom: '24px' }}>You have mastered patch discipline for LLM-assisted coding</p>
          </div>
